...
#define VERBIO_GRAMMAR_VVI          0x04000000     
...
#define VERBIO_NLSML_MRCPv2			0x00000020
#define VERBIO_NLSML_ALTITUDE		0x00000040
...
public:
	...
	virtual const char *RFC2Verbio(const char *language) = 0;
	virtual const char *Verbio2RFC(const char *language) = 0;
...
public:
	...
	virtual int SpeakerAddFile (const char *id, const char *filename, const char *transcription, unsigned int mode) = 0;
	virtual int SpeakerTrain (const char *id, const char *filename, int *lpiword, unsigned int mode) = 0;
	virtual int	SpeakerVerify (const char *id, const char *filename, const char *transcription, float *score, unsigned int mode) = 0;
