...
/* Dialectos */
#define LNG_CATALAN_NORTHWEST      "ca-no"
#define LNG_CATALAN_EAST	       "ca-ca"
#define LNG_CATALAN_BALEARIC       "ca-ba"
...
#define CFG_ANALYTICS_EMOTION        "em_sa"
...
/* vox_spk_verify modes */
#define MC_CHECKINT        0x00020000     /* Check audio integrity */

/* File types */
#define MC_MULAW           0x00000000     /* mu-law Dialogic (raw) */
#define MC_ALAW            0x00000020     /* a-law Dialogic (raw)  */
#define MC_WAVE            0x00000200     /* wave file */
...
#define VXGB_VSDFINAL      0xE0000201
#define VXGB_VSDFINALHIGH  0xE0000202
#define VXGB_VSDLOW        0xE0000203
#define VXGB_VSDHIGH       0xE0000204
#define VXGB_VSDMAXREFAC   0xE0000205
#define VXGB_VSDVOICEREQMS 0x60000206
#define VXGB_VSDSILREQMS   0x60000207
#define VXGB_REALTIME      0x60000209
...
int    VERBIOAPI vox_getusedasrlic();
int    VERBIOAPI vox_getusedttslic();
...
typedef struct {
        ...
        unsigned int files_age;
        unsigned int speech_ms;
} ASV_SPKINFO;

int    VERBIOAPI vox_asv_init();
int    VERBIOAPI vox_asv_addfile (int dev, const char *id, const char *filename, const char *transcription, unsigned int mode);
int    VERBIOAPI vox_asv_train (int dev, const char *id, const char *filename, int *lpiword, unsigned int mode);
int    VERBIOAPI vox_asv_verify (int dev, const char *id, const char *filename, const char *transcription, float *score, unsigned int mode);
int    VERBIOAPI vox_asv_spkinfo (int dev, const char *id, ASV_SPKINFO *info);
//--------------------------------------------------------
